...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"932ddd41-a8bd-4114-91ee-b667023478bb\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [28 x i8] c"com.klipeio.projecthercules\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555270, ; android_runtime_jnienv_class_token
	i32 100672345, ; jnienv_initialize_method_token
	i32 100672344, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.31 = internal constant [30 x i8] c"libaot-ProjectHercules.dll.so\00", align 16
@__DSOCacheEntry_name.32 = internal constant [45 x i8] c"libaot-System.Diagnostics.TraceSource.dll.so\00", align 16
@__DSOCacheEntry_name.33 = internal constant [41 x i8] c"libaot-Xamarin.AndroidX.ViewPager.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [494 x %struct.DSOCacheEntry] [
	...
	; 31
	%struct.DSOCacheEntry {
		i64 1162540937077143031, ; hash 0x10222cd2a75535f7, from name: aot-ProjectHercules
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.31, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 32
	%struct.DSOCacheEntry {
	...
	; 102
	%struct.DSOCacheEntry {
		i64 4033861704868080852, ; hash 0x37fb27d927b6acd4, from name: ProjectHercules.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.31, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 296
	%struct.DSOCacheEntry {
		i64 11396073265267103470, ; hash 0x9e26fc417a9256ee, from name: libaot-ProjectHercules
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.31, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 386
	%struct.DSOCacheEntry {
		i64 14382632546977035279, ; hash 0xc79960195989b40f, from name: libaot-ProjectHercules.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.31, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 397
	%struct.DSOCacheEntry {
		i64 14783156087408034742, ; hash 0xcd285223111c03b6, from name: ProjectHercules
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.31, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 468
	%struct.DSOCacheEntry {
		i64 17699992008436044775, ; hash 0xf5a300f3fe1553e7, from name: aot-ProjectHercules.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.31, i32 0, i32 0), ; name
		i8* null; handle
	}, 
